...
!developmentChains.includes(network.name)
    ...
    : describe("Raffle Unit Test", function () {
          let deployer, raffle, vrfCoordinatorV2Mock, raffleEntranceFee, interval, accounts
          ...
          describe("constructor", function () {
              it("Initiallize the raffleState correctly", async function () {
          ...
          describe("enter raffle", function () {
              it("revert when you don't pay enough", async function () {
                  ...
                  ).to.be.revertedWith("Raffle__NotEnoughFeeEntered")
              })
              ...
              it("doesn't allow entrance when it's calculating", async function () {
                  ...
                  // the time interval has passed, checkupkeep must return true now.
          ...
          describe("checkUpkeep", function () {
              it("returns false if eople haven't, sent any ETH", async function () {
                  await network.provider.send("evm_increaseTime", [interval.toNumber() + 1])
                  await network.provider.send("evm_mine", [])
          ...
          describe("fulfillRandomWords", function () {
              ...
              it("can only be called after checkUpkeep", async function () {
                  await expect(
